...
QT_MOC_LITERAL(5, 46, 16), // "drawSpacePlanets"
QT_MOC_LITERAL(6, 63, 9), // "drawLines"
QT_MOC_LITERAL(7, 73, 11), // "drawPlanets"
QT_MOC_LITERAL(8, 85, 9), // "drawSigns"
QT_MOC_LITERAL(9, 95, 11) // "setGraphics"

    },
    "GraphicsView\0resizeEvent\0\0QResizeEvent*\0"
    "event\0drawSpacePlanets\0drawLines\0"
    "drawPlanets\0drawSigns\0setGraphics"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->drawSpacePlanets(); break;
        case 2: _t->drawLines(); break;
        case 3: _t->drawPlanets(); break;
        case 4: _t->drawSigns(); break;
        case 5: { bool _r = _t->setGraphics();
        ...
        {
            using _t = void (GraphicsView::*)(QResizeEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::resizeEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsView::resizeEvent(QResizeEvent * _t1)
{
